...
namespace CodeMonkey.MonoBehaviours
{
    ...
    public class CameraFollowSetup : MonoBehaviour
    {
        ...
        [SerializeField] private readonly CameraFollow cameraFollow;
        [SerializeField] private readonly Transform followTransform;
        [SerializeField] private readonly float zoom;
